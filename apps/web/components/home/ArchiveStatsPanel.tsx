...
export function ArchiveStatsPanel({ stats }: { stats: ViewerStats }) {
  return (
    <div className="rounded-2xl border border-line bg-surface p-4">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div>
          <b className="block font-display text-[22px] font-extrabold tabular-nums">{stats.eventCount}</b>
          <span className="font-mono text-[8.5px] uppercase tracking-wide text-muted">event</span>
        </div>
        <div>
          <b className="block font-display text-[22px] font-extrabold tabular-nums">{stats.stadiumCount}</b>
          <span className="font-mono text-[8.5px] uppercase tracking-wide text-muted">tribün</span>
        </div>
        <div>
          <b className="block font-display text-[22px] font-extrabold tabular-nums">{stats.listCount}</b>
